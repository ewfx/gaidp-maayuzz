...
7. In the .env file present/create a .env file in root directory("code" directory), please paste your Hugging Face API token(Do not paste your token in "", Sample code line(and the only line to be added) in the .env file is : 
